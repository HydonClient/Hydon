...
public class HydonMainGui extends GuiScreen {
    ...
    public HydonMainGui() {
        ...
        animationElements.addElements(
                new SettingsToggle("1.7 Block Hitting", Hydon.SETTINGS.oldBlockHit,
                        result -> Hydon.SETTINGS.oldBlockHit = result));
        animationElements.addElements(
                new SettingsToggle("1.7 Bow", Hydon.SETTINGS.oldBow,
                        result -> Hydon.SETTINGS.oldBow = result));
        animationElements.addElements(
                new SettingsToggle("1.7 Rod", Hydon.SETTINGS.oldRod,
                        result -> Hydon.SETTINGS.oldRod = result));
        animationElements.addElements(
                new SettingsToggle("1.7 Eating", Hydon.SETTINGS.oldEating,
                        result -> Hydon.SETTINGS.oldEating = result));
        animationElements.addElements(
...
//                        result -> ChatLocker.CHATLOCKER = result));
        ...
        modElement.addElements(autoGG, blockOverlayElements, itemPhysics, keyStrokesElements,
            perspectiveElements);
        ...
        hudItems
            .addElements(note, coordsElements, fpsElements, sprintElements, potionDisplayElements);
