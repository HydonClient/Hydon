...
public class HydonGuiUtilRenderComponents {
    ...
    public static List<IChatComponent> splitText(IChatComponent p_178908_0_, int p_178908_1_, FontRenderer p_178908_2_, boolean p_178908_3_, boolean p_178908_4_) {
        ...
        List<IChatComponent> chatMessage = Lists.newArrayList(p_178908_0_);

        for (int j = 0; j < chatMessage.size(); ++j) {
            IChatComponent component = chatMessage.get(j);
            ...
            if (unformattedText.contains("\n")) {
                ...
                chatcomponenttext.setChatStyle(component.getChatStyle().createShallowCopy());
                chatMessage.add(j + 1, chatcomponenttext);
                flag = true;
            }

            String s4 = GuiUtilRenderComponents.func_178909_a(component.getChatStyle().getFormattingCode() + unformattedText, p_178908_4_);
            ...
            chatcomponenttext1.setChatStyle(component.getChatStyle().createShallowCopy());
            ...
            if (i + i1 > p_178908_1_) {
                ...
                if (s3 != null && s3.length() > 0) {
                    ...
                    chatcomponenttext2.setChatStyle(component.getChatStyle().createShallowCopy());
                    chatMessage.add(j + 1, chatcomponenttext2);
                }
